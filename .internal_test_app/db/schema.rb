...
ActiveRecord::Schema.define(version: 2023_11_20_153325) do
  ...
  create_table "iiif_print_derivative_attachments", force: :cascade do |t|
    t.string "fileset_id"
    t.string "path"
  ...
  create_table "iiif_print_ingest_file_relations", force: :cascade do |t|
    t.string "file_path"
