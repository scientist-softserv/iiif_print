...
RSpec.describe CatalogController do
  ...
  describe 'IiifPrint::InstallGenerator#add_facets_to_catalog_controller' do
    subject { described_class.blacklight_config.facet_fields }

    it 'has IiifPrint facet fields' do
  ...
  describe 'IiifPrint::InstallGenerator#add_pubdate_sort_to_catalog_controller' do
    subject { described_class.blacklight_config.sort_fields }

    it 'has IiifPrint sort fields' do
