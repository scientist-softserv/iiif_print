   ...
   3. Adds sort fields in CatalogController
    ...
    def add_index_fields_to_catalog_controller
      ...
      inject_into_file 'app/controllers/catalog_controller.rb', after: marker do
        ...
        "    config.add_index_field 'publication_title_ssi', label: I18n.t('iiif_print.attributes.publication_title.label'), link_to_search: 'publication_title_ssi'\n"\
        ...
        "    config.add_index_field solr_name('place_of_publication_label', :stored_searchable), label: I18n.t('iiif_print.attributes.place_of_publication.label'), link_to_search: solr_name('place_of_publication_label', :facetable)\n"\
